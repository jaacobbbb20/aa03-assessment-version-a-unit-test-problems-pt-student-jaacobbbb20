# JavaScript 3a Assessment - Coding Portion

Welcome to your third assessment!
...
in the __problem/01-shortest-to-longest.js__ file by itself, you would run `npm
test test/01-shortest-to-longest-spec.js`.

Here are the commands to run each of the four test files individually:

```sh
npm test test/01-shortest-to-longest-spec.js
npm test test/02-print-numbers-between-spec.js
npm test test/03-dynamic-cipher-spec.js
npm test test/04-morse-code-spec.js
```
